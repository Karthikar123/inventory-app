...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold text-success">📦 High Stock Products (> 100)</h2>
        ...
        <table class="table table-bordered table-hover bg-white">
            ...
            @foreach ($products as $index => $product)
                <tr>
                    ...
                    <td class="text-center fw-bold text-success">{{ $product->quantity }}</td>
    ...
    @else
        <div class="alert alert-info">No high stock products found.</div>
    @endif
</div>
@endsection
